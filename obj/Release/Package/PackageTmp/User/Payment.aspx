<%@ Page Title="" Language="C#" MasterPageFile="~/User/user.Master" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="Bitirme_Restoran.User.Payment" %>
        ...
        <div class="container py-5">
            ...
            <div class="row mb-4">
                <div class="col-lg-8 mx-auto text-center">
                    <h1 class="display-6">sipariş ödemesi</h1>
                </div>
            </div>
            <!-- End -->
            <div class="row pb-5">
                <div class="col-lg-6 mx-auto">
                    <div class="card ">
                        <div class="card-header">
                            <div class="bg-white shadow-sm pt-4 pl-2 pr-2 pb-2">
                                ...
                                <ul role="tablist" class="nav bg-light nav-pills rounded nav-fill mb-3">
                                    ...
                                    <li class="nav-item"><a data-toggle="pill" href="#paypal" class="nav-link "><i class="fa fa-money mr-2"></i>Nakit Ödeme </a></li>
                            ...
                            <div class="tab-content">
                                ...
                                <div id="credit-card" class="tab-pane fade show active pt-3">
                                    <div role="form">
                                        <div class="form-group">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvName" runat="server" ErrorMessage="İsim Gereklidir."
                                            ...
                                            <asp:TextBox ID="txtName" runat="server" CssClass="form-control" placeholder="Kart Sahibinin Adı"></asp:TextBox>
                                        </div>
                                        <div class="form-group">
                                            <label for="txtCardNo">
                                                <h6>Kart Numarası</h6>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-8">
                                                <div class="form-group">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="rfvExpMonth" runat="server" ErrorMessage="Son Kullanma Ayı Gereklidir."
                                                    ...
                                                    <asp:RequiredFieldValidator ID="rfvExpYear" runat="server" ErrorMessage="Son Kullanma Yılı Gereklidir."
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group mb-4">
                                                    <label data-toggle="tooltip" title="Kartınızın arkasındaki üç haneli CV kodu">
                                                        <h6>CVV <i class="fa fa-question-circle d-inline"></i></h6>
                                                    </label>
                                                    <asp:RequiredFieldValidator ID="rfvCvv" runat="server" ErrorMessage="CVV No Gereklidir."
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvAddress" runat="server" ErrorMessage="Adres Gereklidir." ForeColor="Red"
                                        ...
                                        <div class="card-footer">
                                            <asp:LinkButton ID="lbCardSubmit" runat="server" CssClass="subscribe btn btn-info btn-block shadow-sm"
                                                ValidationGroup="card" OnClick="lbCardSubmit_Click">Siparişi Tamamla</asp:LinkButton>
                                        </div>
                                    </div>
                                </div>
                                <!-- End -->
                                ...
                                <div id="paypal" class="tab-pane fade pt-3">
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvCODAddress" runat="server" ErrorMessage="Adres Gereklidir." ForeColor="Red"
                                    ...
                                    <p>
                                        <asp:LinkButton ID="lbCodSubmit" runat="server" CssClass="btn btn-info" ValidationGroup="cod" OnClick="lbCodSubmit_Click">
                                            <i class="fa fa-cart-arrow-down mr-2"></i>Siparişi Tamamla</asp:LinkButton>
                                    </p>
                                    <p class="text-muted">
                                        Not: Siparişinizi Teslim Aldığınızda Ödemenin Tamamını Yapmanız Gerekmektedir. 
                                    </p>
                                </div>
                                <!-- End -->
                            </div>
                        ...
                        <div class="card-footer">
                            <b class="badge badge-success badge-pill shadow-sm">Sipariş Toplamı:  <% Response.Write(Session["grandTotalPrice"]); %>  ₺</b>
                            <div class="pt-1">
                                <asp:ValidationSummary ID="ValidationSummary1" runat="server" ForeColor="Red" ValidationGroup="card"
                                    HeaderText="Aşağıdaki Hataları Düzeltin" Font-Names="Segoe Script" />
                            </div>
                        </div>
                    </div>
                </div>
