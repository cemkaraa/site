<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Tarif.aspx.cs" Inherits="Bitirme_Restoran.Admin.Tarif" %>
                                            ...
                                            <div class="col-sm-6 col-md-4 col-lg-4">
                                                ...
                                                <div>
                                                    <div class="form-group">
                                                        ...
                                                        <div>
                                                            <asp:TextBox ID="malzeme" runat="server" CssClass="form-control"
                                                                placeholder="Kategori ismini giriniz" required></asp:TextBox>
                                                        ...
                                                        <div>
                                                            <asp:TextBox ID="tarif" runat="server" CssClass="form-control"
                                                                placeholder="Kategori ismini giriniz" required></asp:TextBox>
