<%@ Page Title="" Language="C#" MasterPageFile="~/User/user.Master" AutoEventWireup="true" CodeBehind="Menu.aspx.cs" Inherits="Bitirme_Restoran.User.Menu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
      ...
      <ul class="filters_menu">
        <li class="active" data-filter="*" data-id="0">Tüm Ürünler</li>
          <asp:Repeater ID="rCategory" runat="server">
              <ItemTemplate>
                  <li data-filter=".<%# Regex.Replace(Eval("isim").ToString().ToLower(),@"\s+","") %>"
                       data-id="<%# Eval("KategoriId")%>"><%# Eval("isim") %></li>
              </ItemTemplate>
          </asp:Repeater>
